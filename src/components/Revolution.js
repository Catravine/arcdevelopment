    ...
    <Grid container direction="column">
      ...
      >
        ...
        <Grid item container direction="column" lg style={{maxWidth: "40em"}}>
          <Grid item>
            <Typography variant="h4" gutterButtom align={matchesMD ? "center" : "right"}>
              Vision
            </Typography>
          </Grid>
          <Grid item>
      ...
      >
        <Grid item container direction="column" lg style={{maxWidth: "40em"}}>
          <Grid item>
            <Typography variant="h4" gutterButtom align={matchesMD ? "center" : undefined}>
              Technology
            </Typography>
          </Grid>
          <Grid item>
          ...
          <Grid item>
            <Typography variant="body2" paragraph align={matchesMD ? "center" : undefined}>
              ...
              you already possessed from building websites and reapply it directly! This 
          ...
          <Grid item>
            <Typography variant="body2" paragraph align={matchesMD ? "center" : undefined}>
              ...
              setup and deployment, allowing creators to focus as much as possible on 
              their work itself.
            </Typography>
          </Grid>
          <Grid item>
        ...
        >
          ...
          <Grid item>
            ...
            >
              ...
              idea for where to start and what to do, or if you just know 
              you want to step things up, our initial consultation will 
        ...
        >
          ...
          <Grid item>
            ...
            >
              ...
              you the freedom to discuss any changes you may want or any ideas you may 
              have come up with before any heavy lifting has been done.
            </Typography>
            <Typography 
              variant="body2" 
              paragraph 
        ...
        >
          ...
          <Grid item>
            ...
            >
              ...
              scaffolding out the project on a high level, prioritizing some areas over 
              others.
            </Typography>
            <Typography 
              variant="body2" 
            ...
            >
              ...
              Once all the services are in place we can then create the front end, user 
              side of things.
            </Typography>
            <Typography 
              variant="body2" 
        ...
        >
          ...
          <Grid item>
            ...
            <Typography 
              ...
              align={matchesMD ? "center" : undefined}
            >
              When construction comes to a close you’re the first one to know. We’ll give 
              our final demonstration to show off your shiny new software in the wild 
        ...
        >
          ...
          <Grid item>
            ...
            <Typography 
              ...
              align={matchesMD ? "center" : undefined}
            >
              Our iterative process will keep you current and competitive, allowing you 
              to quickly implement changes instead of waiting months for a single update.
            </Typography>
          </Grid>
        </Grid>
        <Grid item lg style={{alignSelf: "center"}}>
