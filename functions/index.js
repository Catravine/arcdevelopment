...
exports.sendMail = functions.https.onRequest((request, response) => {
  cors(request, response, () => {
    const {name, email, phone, message, total, services, platforms,
      features, customFeatures, users, category} = request.query;

    if (total) {
      if (category) {
        mailOptions = {
          from: "Arc Development",
          to: "fakeemail@carolinecourtney.com",
          ...
          html: `
            ...
            <p style="font-size: 16px">Service: ${services}</p>
      ...
      mailOptions = {
        ...
        html: `
          ...
          stroke="false" style="width:600px;height:617px;">
          ...
          cellspacing="0"
          cellpadding="0"
          style="background:#0B72B9; border-radius:10px; 
          ...
          <td
          align="center"
          style="font-family: 'Pacifico', Tahoma; font-size:34.28px; 
          font-weight:normal; 
          ...
          font-size:20px; font-weight:normal; line-height:25.50px; 
          ...
          valign="middle"
          width="64.666666%"
          style="width: 64.666666%; background-repeat:no-repeat; 
          ...
          font-family: 'Roboto', Tahoma, Segoe, sans-serif; 
          font-size:13.70px; font-weight:normal; line-height:14px; 
